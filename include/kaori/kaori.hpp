#ifndef KAORI_KAORI_HPP
#define KAORI_KAORI_HPP
...
/**
 * @file kaori.hpp
 * @brief Umbrella includes for the **kaori** barcode-matching library.
 */

/**
 * @namespace kaori
 * @brief Namespace for the **kaori** barcode-matching library.
 */
namespace kaori {}
